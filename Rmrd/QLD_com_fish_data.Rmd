---
title: "CPUE: QLD Commercial line Fisheries"
author: "Claire Kirby"
...
```{r}
# Fill "species" across the blanks
...
```{r}
# Revise column names: Year,Species, "measures"(licenses, day, and tonnes)
...
#Reshape wide--> split column names into "Species_raw" and values (Licences, Days, and Tonnes)
...
# Keep only the 4 targeted species (exclude others like Snapper-saddleback)
...
# Standardize labels and clean columns
  mutate(
...
#Keep only final cleaned columns and order by year and species
  
  select(year, species, licences, days, tonnes) %>%
  arrange(year, species)

print(fish_data, n =30)
```
